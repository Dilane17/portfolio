...
export default function ProjectCard({
  ...
  const onMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    card.style.transition =
      "transform 0.08s ease, box-shadow 0.08s ease, border-color 0.3s ease";
    card.style.transform = `perspective(1200px) rotateX(${rx}deg) rotateY(${ry}deg) translateZ(8px)`;
    card.style.boxShadow =
      "0 24px 60px rgba(25, 43, 194, 0.18), 0 8px 24px rgba(0, 0, 0, 0.35)";
  ...
  return (
    ...
    >
      ...
      <div className={styles.mockupBox}>
        <Image
          src={`/case-studies/${slug}/preview.png`}
